...
\node[fill=black!40] at (0,3) {1};
\node[fill=black!60] at (0,4) {3};
...
\node[fill=black!10] at (2,0) {12};
\node[fill=black!30] at (2,1) {14};
\node[fill=black!00] at (2,2) {16};
\node[fill=black!50] at (2,3) {13};
\node[fill=black!70] at (2,4) {15};
\node[fill=black!40] at (2,5) {17};
\node[fill=black!20] at (3,0) {18};
\node[fill=black!10] at (3,1) {20};
\node[fill=black!30] at (3,2) {22};
\node[fill=black!60] at (3,3) {19};
\node[fill=black!50] at (3,4) {21};
